...
class TruncatedLevyWalkWithFixInitialPositions(TruncatedLevyWalk):
    ...
    def initial_positions(self, ndim, nodes):
        print "pepess"
        return StochasticWalk.initial_positions(self, ndim, nodes)

    def __init__(self, nr_nodes, dimensions, FL_EXP=-2.6, FL_MAX=50., WT_EXP=-1.8, WT_MAX=100., border_policy='reflect', positions_file):
